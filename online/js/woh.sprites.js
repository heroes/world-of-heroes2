...
Laro.NS('woh', function(L) {
    var Sprite = L.Class(function(data, brain) {
        ...
        getAnimations: function() {
            ...
            Object.defineProperty(this.animations, "attack", {
                get: function() {
        ...
        setAndPlay: function(animation, loop, start, end) {
            ...
            if (animation == 'attack') {
                woh.loader.loadedSounds['sound/attack.mp3'] && woh.loader.loadedSounds['sound/attack.mp3'].play()
            }
            if (this.attackBuff && animation == 'attack') {
                woh.util.shakeScreen();
                setTimeout('woh.util.stopShakeScreen()', 1000);
            }
        ...
        onAnimationEvent: function(evt, anim) {
            ...
            switch (evt) {
                case "stopped":
                    this.fsm.message(woh.roleMessages.animStopped);
                    break;
                case "standup":
                    //with(this.getPos())
                ...
                case "attack_affect":
                    ...
                    if (this.attackBuff) {
                        this.attackBuff.converter.convert(damageData);
                        this.attackBuff = null;
                    }
