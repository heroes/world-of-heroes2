...
woh.g_config.script={
    ...
    '4':{
        ...
        repeat:false,
        data:[
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'唐如','content':'好美的人哦……',position:'left',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'？？','content':'你知道……人鱼吗？',position:'right',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'唐如','content':'人鱼？古书里面倒是记载着不少关于这个的传说……',position:'left',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'','name':'','content':'喂喂喂，你怎么了！',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'？？','content':'……',position:'right',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'唐如','content':'你没事吧，醒醒啊！呼吸很平稳，看来只是晕过去了而已。',position:'left',globalBg : 'resources/images/bg/game-bg-beach.jpg'},
            {'avatar':'resources/images/dialogue/UI-dialog-character.png','name':'唐如','content':'天啊，哪来那么多的大螃蟹！不好，螃蟹似乎是冲着那个人来的。不管怎么样，先把它们击退吧。',position:'left',globalBg : 'resources/images/bg/game-bg-beach.jpg'}
        ],
        next:'5'
    },
    // 
